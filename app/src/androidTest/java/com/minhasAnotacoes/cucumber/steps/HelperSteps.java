...
import com.minhasAnotacoes.util.SpoonScreenshotAction;
...
public class HelperSteps {
    ...
    public static void takeScreenshot(final String tag) {
        ...
        if (screenshot == null) {
            throw new ScreenshotException("Screenshot cls not taken correctly, check for failures in screenshot library");
        }
